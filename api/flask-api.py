...
# yolo model 불러오기
model = torch.hub.load('../yolov5/', 'custom', path='./yolov5/runs/train/model_v3/weights/best.pt', source='local')
...
#         check = True         # 바퀴벌레 여부를 알려줄 변수
#         answer = ""
#         for i in range(len(result)):
#             if result[i] == "Cockroach":
#                 check = False
#                 answer = "Detect"
#                 break
        
#         if check:
#             answer = "Not Cockroach"
